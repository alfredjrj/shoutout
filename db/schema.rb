...
ActiveRecord::Schema.define(version: 20160605074423) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.integer  "get_fame_id"
  end

  add_index "posts", ["get_fame_id", "created_at"], name: "index_posts_on_get_fame_id_and_created_at", using: :btree
  add_index "posts", ["get_fame_id"], name: "index_posts_on_get_fame_id", using: :btree
  ...
  add_foreign_key "posts", "get_fames"
